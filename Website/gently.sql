...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2015 at 01:45 AM
...
CREATE TABLE IF NOT EXISTS `favourites` (
  `username` varchar(32) NOT NULL,
  `favourites` varchar(32) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
